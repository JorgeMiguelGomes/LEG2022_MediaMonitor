...
df_filter.to_csv('../legislativas_2022_media_monitor_29jan2022_filter_data/crowdtangle_2022_01_29_ruitavares_last_30_days_dataset_filter.csv')
...
fig_main = px.bar(df_c, x='Page Name' , y='Counts',template='plotly_white',
                  title='Rui Tavares - Total Mentions by Media Outlet<br><sup>Period:30/12/2021 to 29/01/2022</sup>',
                  color_discrete_sequence=["#00CE8C"], 
                  text='Counts'
                 )

fig_main.update_traces(textfont_size=12, textangle=0, textposition="outside", cliponaxis=False)

fig_main.write_image("../legislativas_2022_media_monitor_29jan2022_graphs/legislativas_2022_images_ruitavares_total.png",  width=1920, height=1080, scale=4)
# fig_main.show()
