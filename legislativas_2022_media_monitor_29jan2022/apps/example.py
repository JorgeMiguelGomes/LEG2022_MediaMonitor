    ...
    [
        ...
        dbc.Row( 
            [ # you have to create a children's array to have more than one column in a row 
                dbc.Col(html.H3("Legislativas 2022 Media Monitor"), width={'size': 6, 'offset':0}), #First Column
        ...
        dbc.Row(
            [
            dbc.Col(html.H5("Observing Media Trends"), width={'size':3, 'offset':0}), # second row
                        ...
                        [
                            dbc.Col(
                                dcc.Dropdown(
                                    ...
                                    options=[
                                        {'label': 'Total Interactions', 'value': 'Total Interactions_Percentages'} ,
